...
typedef enum ImageLoaderFlags {
	GCTK_IMAGE_CLAMP_R			= 0x00000001,
	GCTK_IMAGE_CLAMP_S			= 0x00000010,
	GCTK_IMAGE_CLAMP_T			= 0x00000100,
	GCTK_IMAGE_POINT_FILTER		= 0b00001000,
	GCTK_IMAGE_GENERATE_MIPMAPS = 0b00010000,
	GCTK_IMAGE_CLAMP			= GCTK_IMAGE_CLAMP_R | GCTK_IMAGE_CLAMP_T | GCTK_IMAGE_CLAMP_S
} ImageLoaderFlags;
